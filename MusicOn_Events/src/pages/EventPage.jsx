...
export const loader = async ({ params }) => {
  const event = await fetch(
    `https://mock-music-on.onrender.com/events/${params.eventId}`
  );

  const users = await fetch("https://mock-music-on.onrender.com/users");

  const categories = await fetch(
    "https://mock-music-on.onrender.com/categories"
  );
...
export const EventPage = () => {
  ...
  const handleDelete = async () => {
    await fetch(`https://mock-music-on.onrender.com/events/${params.eventId}`, {
      method: "DELETE",
    });
        ...
        <div className="event-hero-text">
          ...
          <div className="eventpage-links">
            ...
            <Link to="/events" className="back-link">
              <Text mb="2rem" as="ins" color="black">
                Back to Events
              </Text>
            </Link>
          </div>
